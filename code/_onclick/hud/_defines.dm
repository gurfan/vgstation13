...
//Middle right (status indicators) for vampires
#define ui_internal_vamp "EAST-1:[28*PIXEL_MULTIPLIER],CENTER-0.5:[19*PIXEL_MULTIPLIER]"
#define ui_health_vamp "EAST-1:[28*PIXEL_MULTIPLIER],CENTER-1.5:[17*PIXEL_MULTIPLIER]"
