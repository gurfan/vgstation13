...
/datum/design/accountdatabase
	name = "Circuit Design (Accounts Database)"
	desc = "Allows for the construction of circuit boards used to build an accounts database."
	id = "accountsdatabase"
	req_tech = list(Tc_PROGRAMMING = 2, Tc_BLUESPACE = 2)
	build_type = IMPRINTER
	materials = list(MAT_GLASS = 2000, SACID = 20)
	category = "Machine Boards"
	build_path = /obj/item/weapon/circuitboard/accounts
